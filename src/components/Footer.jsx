...
const Footer = () => {
  return (
    <div className="Footer w-full h-screen bg-zinc-100 text-[#D3CFCA] relative flex p-[3vw]">
      ...
      <div className="w-1/2">
          ...
          <div>
            {[
              ...
              <div className="flex flex-col">
                <a
                  className="text-[1.2vw] cursor-pointer"
                  key={idx}
                  href={item.href}
                  target="_blank"
        ...
        <div className="flex justify-between w-[44vw]">
          <div>
            <div className="flex flex-col">
              <h6 className="text-[1.2vw]">L:</h6>
              <div>
                {[
                  "202-1965 W 4th Ave",
                  "Vancouver",
        ...
        <div className="flex flex-col mt-[2vw]">
          <h6 className="text-[1.2vw]">E:</h6>
          <div>
            {[{ name: "hello@ochi.design", href: "hello@ochi.design" }].map(
              (item, idx) => (
                <div className="flex flex-col">
                  <a
                    className="cursor-pointer text-[1.2vw] "
        ...
        <div className="flex justify-between mt-[1vw]">
          <span>
            <h6 className="text-[1.2vw]">
              © ochi design 2024. <a href="https://ochi.design/privacy/">Legal Terms</a>{" "}
            </h6>
          </span>
          <span>
            <h6 className="text-[1.2vw]">Website by Obys</h6>
          </span>
        </div>
      </div>
    </div>
